...
function saveTasks(){                                        //local storage handling(task ko local memory me save)                                                                   
    localStorage.setItem('tasks',JSON.stringify(tasks));     //page ko refresh karne per delete karne data local storage per save rhe
}
})